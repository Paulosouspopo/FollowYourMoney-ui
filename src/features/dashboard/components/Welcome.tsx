  ...
  return (
    <div className="glow -mx-4 px-4 md:mx-0 md:px-8 md:rounded-3xl pt-8 pb-4 lg:pt-12">
      <div className="max-w-2xl">
        ...
        <Button size="lg" className="mt-7 rounded-xl" onClick={() => setCreating(true)}>
      ...
      <p className="mt-6 text-xs text-muted-foreground">
        Envie de regarder d'abord ? <Link to="/markets" className="font-medium text-primary">Suis quelques actifs dans Marchés</Link>.
      </p>
